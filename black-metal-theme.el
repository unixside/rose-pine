;; black-metal-theme.el --- -*- lexical-binding: t -*-
(require 'modus-themes)

(defvar black-metal-palette
  (modus-themes-generate-palette
   '(
     ...
     (green-cooler     "#cc8888")
     (green-faint      "#cc8888")
     (green-intense    "#e8a8a8")

     (yellow           "#a06666")
     (yellow-warmer    "#b07070")
     (yellow-cooler    "#905858")
     (yellow-faint     "#905858")
     (yellow-intense   "#b07070")
     ...
     (bg-green-subtle    "#3a2830")
     (bg-green-faint      "#2a1820")
     (bg-green-nuanced    "#2a1820")
     (bg-green-intense    "#50384a")

     (bg-yellow-subtle   "#2a2020")
     (bg-yellow-faint     "#1a1010")
     (bg-yellow-nuanced   "#1a1010")
     (bg-yellow-intense   "#403030")
     ...
     (modeline-err     "#5f8787")
     (modeline-warning "#a06666")
     (modeline-info    "#dd9999")
     ...
     ;; Diffs
     (bg-added           "#1a2a2a")
     (bg-added-faint     "#122020")
     (bg-added-refine    "#1a3a3a")
     (bg-added-fringe    "#2a5050")
     (fg-added           "#dd9999")
     (fg-added-intense   "#e8a8a8")

     (bg-changed         "#2a2220")
     (bg-changed-faint   "#1a1510")
     (bg-changed-refine  "#3a3028")
     (bg-changed-fringe  "#504040")
     (fg-changed         "#a06666")
     (fg-changed-intense "#b07070")
  ...
  "Color palette of the base variant of the Black Metal theme.")

(modus-themes-theme
 'black-metal
 'black-metal-themes
 "Black Metal theme base variant generated with modus-themes-tool."
 'dark
 'black-metal-palette
 nil
 nil)

(provide-theme 'black-metal)
