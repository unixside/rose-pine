;; black-metal-burzum-theme.el --- -*- lexical-binding: t -*-
(require 'modus-themes)

(defvar black-metal-burzum-palette
  (modus-themes-generate-palette
   '(
     ...
     (green-cooler     "#cddebc")
     (green-faint      "#cddebc")
     (green-intense    "#edfedc")

     (yellow           "#99bbaa")
     (yellow-warmer    "#a9cbba")
     (yellow-cooler    "#89ab9a")
     (yellow-faint     "#89ab9a")
     (yellow-intense   "#a9cbba")
     ...
     (bg-green-subtle    "#161714")
     (bg-green-faint      "#0e0f0c")
     (bg-green-nuanced    "#0e0f0c")
     (bg-green-intense    "#282b24")

     (bg-yellow-subtle   "#131816")
     (bg-yellow-faint     "#0c0f0e")
     (bg-yellow-nuanced   "#0c0f0e")
     (bg-yellow-intense   "#242c28")
     ...
     (modeline-err     "#5f8787")
     (modeline-warning "#99bbaa")
     (modeline-info    "#ddeecc")
     ...
     ;; Diffs
     (bg-added           "#121310")
     (bg-added-faint     "#0b0b0a")
     (bg-added-refine    "#181916")
     (bg-added-fringe    "#262823")
     (fg-added           "#ddeecc")
     (fg-added-intense   "#edfedc")

     (bg-changed         "#101312")
     (bg-changed-faint   "#090c0b")
     (bg-changed-refine  "#151a18")
     (bg-changed-fringe  "#222926")
     (fg-changed         "#99bbaa")
     (fg-changed-intense "#a9cbba")
  ...
  "Color palette of the burzum variant of the Black Metal theme.")

(modus-themes-theme
 'black-metal-burzum
 'black-metal-themes
 "Black Metal (Burzum) variant generated with modus-themes-tool."
 'dark
 'black-metal-burzum-palette
 nil
 nil)

(provide-theme 'black-metal-burzum)
