;; black-metal-mayhem-theme.el --- -*- lexical-binding: t -*-
(require 'modus-themes)

(defvar black-metal-mayhem-palette
  (modus-themes-generate-palette
   '(
     ...
     (green-cooler     "#e3dcc4")
     (green-faint      "#e3dcc4")
     (green-intense    "#fffce4")

     (yellow           "#eecc6c")
     (yellow-warmer    "#fedc7c")
     (yellow-cooler    "#debc5c")
     (yellow-faint     "#debc5c")
     (yellow-intense   "#fedc7c")
     ...
     (bg-green-subtle    "#171614")
     (bg-green-faint      "#0e0e0c")
     (bg-green-nuanced    "#0e0e0c")
     (bg-green-intense    "#2a2824")

     (bg-yellow-subtle   "#1c180c")
     (bg-yellow-faint     "#120f08")
     (bg-yellow-nuanced   "#120f08")
     (bg-yellow-intense   "#332c17")
     ...
     (modeline-err     "#5f8787")
     (modeline-warning "#eecc6c")
     (modeline-info    "#f3ecd4")
     ...
     (bg-added-refine    "#191816")
     (bg-added-fringe    "#282622")
     (fg-added           "#f3ecd4")
     (fg-added-intense   "#fffce4")

     (bg-changed         "#17140a")
     (bg-changed-faint   "#0e0c06")
     (bg-changed-refine  "#1f1a0e")
     (bg-changed-fringe  "#312a16")
     (fg-changed         "#eecc6c")
     (fg-changed-intense "#fedc7c")
  ...
  "Color palette of the mayhem variant of the Black Metal theme.")

(modus-themes-theme
 'black-metal-mayhem
 'black-metal-themes
 "Black Metal (Mayhem) variant generated with modus-themes-tool."
 'dark
 'black-metal-mayhem-palette
 nil
 nil)

(provide-theme 'black-metal-mayhem)
