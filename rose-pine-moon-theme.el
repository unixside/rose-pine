;; rose-pine-moon-theme.el --- -*- lexical-binding: t -*-
(require 'modus-themes)

(defvar rose-pine-moon-palette
  (modus-themes-generate-palette
   '(
     ...
     ;; Accent foregrounds - Rose Pine Moon colors
     (red              "#eb6f92")
     (red-warmer       "#ec6082")
     (red-cooler       "#d08090")
     (red-faint        "#d0677d")
     ...
     (bg-green-subtle    "#1f3035")
     (bg-green-faint      "#152025")
     (bg-green-nuanced    "#152025")
     (bg-green-intense    "#306050")
...
(modus-themes-theme
 'rose-pine-moon
 'rose-pine-themes
 "Rose-Pine theme moon variant generate with modus-themes-tool."
 'dark
