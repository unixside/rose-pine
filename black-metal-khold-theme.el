;; black-metal-khold-theme.el --- -*- lexical-binding: t -*-
(require 'modus-themes)

(defvar black-metal-khold-palette
  (modus-themes-generate-palette
   '(
     ...
     (green-cooler     "#dcded3")
     (green-faint      "#dcded3")
     (green-intense    "#fcfef3")

     (yellow           "#974b46")
     (yellow-warmer    "#a75b56")
     (yellow-cooler    "#873b36")
     (yellow-faint     "#873b36")
     (yellow-intense   "#a75b56")
     ...
     (bg-green-intense    "#282826")

     (bg-yellow-subtle   "#21100f")
     (bg-yellow-faint     "#150a09")
     (bg-yellow-nuanced   "#150a09")
     (bg-yellow-intense   "#3d1e1c")
     ...
     (modeline-err     "#5f8787")
     (modeline-warning "#974b46")
     (modeline-info    "#eceee3")
     ...
     (bg-added-fringe    "#262624")
     (fg-added           "#eceee3")
     (fg-added-intense   "#fcfef3")

     (bg-changed         "#1b0d0c")
     (bg-changed-faint   "#100807")
     (bg-changed-refine  "#241211")
     (bg-changed-fringe  "#3a1c1a")
     (fg-changed         "#974b46")
     (fg-changed-intense "#a75b56")
  ...
  "Color palette of the khold variant of the Black Metal theme.")

(modus-themes-theme
 'black-metal-khold
 'black-metal-themes
 "Black Metal (Khold) variant generated with modus-themes-tool."
 'dark
 'black-metal-khold-palette
 nil
 nil)

(provide-theme 'black-metal-khold)
