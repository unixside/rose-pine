;; black-metal-gorgoroth-theme.el --- -*- lexical-binding: t -*-
(require 'modus-themes)

(defvar black-metal-gorgoroth-palette
  (modus-themes-generate-palette
   '(
     ...
     (green-cooler     "#8b7d6f")
     (green-faint      "#8b7d6f")
     (green-intense    "#ab9d8f")

     (yellow           "#8c7f70")
     (yellow-warmer    "#9c8f80")
     (yellow-cooler    "#7c6f60")
     (yellow-faint     "#7c6f60")
     (yellow-intense   "#9c8f80")
     ...
     (bg-green-faint      "#0f0e0c")
     (bg-green-nuanced    "#0f0e0c")
     (bg-green-intense    "#2b2824")

     (bg-yellow-subtle   "#181613")
     (bg-yellow-faint     "#0f0e0c")
     (bg-yellow-nuanced   "#0f0e0c")
     (bg-yellow-intense   "#2c2823")
     ...
     (modeline-err     "#5f8787")
     (modeline-warning "#8c7f70")
     (modeline-info    "#9b8d7f")
     ...
     (bg-added-fringe    "#292622")
     (fg-added           "#9b8d7f")
     (fg-added-intense   "#ab9d8f")

     (bg-changed         "#13120f")
     (bg-changed-faint   "#0c0b09")
     (bg-changed-refine  "#1a1815")
     (bg-changed-fringe  "#2a2621")
     (fg-changed         "#8c7f70")
     (fg-changed-intense "#9c8f80")
  ...
  "Color palette of the gorgoroth variant of the Black Metal theme.")

(modus-themes-theme
 'black-metal-gorgoroth
 'black-metal-themes
 "Black Metal (Gorgoroth) variant generated with modus-themes-tool."
 'dark
 'black-metal-gorgoroth-palette
 nil
 nil)

(provide-theme 'black-metal-gorgoroth)
