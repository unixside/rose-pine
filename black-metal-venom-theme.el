;; black-metal-venom-theme.el --- -*- lexical-binding: t -*-
(require 'modus-themes)

(defvar black-metal-venom-palette
  (modus-themes-generate-palette
   '(
     ...
     (green-cooler     "#e8e7e2")
     (green-faint      "#e8e7e2")
     (green-intense    "#ffffff")

     (yellow           "#79241f")
     (yellow-warmer    "#89342f")
     (yellow-cooler    "#69140f")
     (yellow-faint     "#69140f")
     (yellow-intense   "#89342f")
     ...
     (bg-green-subtle    "#161615")
     (bg-green-faint      "#0e0e0d")
     (bg-green-nuanced    "#0e0e0d")
     (bg-green-intense    "#282827")

     (bg-yellow-subtle   "#2a0c0a")
     (bg-yellow-faint     "#1b0806")
     (bg-yellow-nuanced   "#1b0806")
     (bg-yellow-intense   "#4d1613")
     ...
     (modeline-err     "#5f8787")
     (modeline-warning "#79241f")
     (modeline-info    "#f8f7f2")
     ...
     (bg-added-refine    "#181817")
     (bg-added-fringe    "#262625")
     (fg-added           "#f8f7f2")
     (fg-added-intense   "#ffffff")

     (bg-changed         "#220a08")
     (bg-changed-faint   "#150605")
     (bg-changed-refine  "#2e0d0b")
     (bg-changed-fringe  "#491512")
     (fg-changed         "#79241f")
     (fg-changed-intense "#89342f")
  ...
  "Color palette of the venom variant of the Black Metal theme.")

(modus-themes-theme
 'black-metal-venom
 'black-metal-themes
 "Black Metal (Venom) variant generated with modus-themes-tool."
 'dark
 'black-metal-venom-palette
 nil
 nil)

(provide-theme 'black-metal-venom)
