;; black-metal-bathory-theme.el --- -*- lexical-binding: t -*-
(require 'modus-themes)

(defvar black-metal-bathory-palette
  (modus-themes-generate-palette
   '(
     ...
     (green-cooler     "#ebbb87")
     (green-faint      "#ebbb87")
     (green-intense    "#ffdba7")

     (yellow           "#e78a53")
     (yellow-warmer    "#f79a63")
     (yellow-cooler    "#d77a43")
     (yellow-faint     "#d77a43")
     (yellow-intense   "#f79a63")
     ...
     (bg-green-subtle    "#1b1610")
     (bg-green-faint      "#110e0a")
     (bg-green-nuanced    "#110e0a")
     (bg-green-intense    "#31281d")

     (bg-yellow-subtle   "#21140c")
     (bg-yellow-faint     "#150c07")
     (bg-yellow-nuanced   "#150c07")
     (bg-yellow-intense   "#3d2416")
     ...
     (modeline-err     "#5f8787")
     (modeline-warning "#e78a53")
     (modeline-info    "#fbcb97")
     ...
     ;; Diffs
     (bg-added           "#16120d")
     (bg-added-faint     "#0d0b08")
     (bg-added-refine    "#1d1811")
     (bg-added-fringe    "#2f261c")
     (fg-added           "#fbcb97")
     (fg-added-intense   "#ffdba7")

     (bg-changed         "#1b1009")
     (bg-changed-faint   "#100a06")
     (bg-changed-refine  "#24150d")
     (bg-changed-fringe  "#3a2214")
     (fg-changed         "#e78a53")
     (fg-changed-intense "#f79a63")
  ...
  "Color palette of the bathory variant of the Black Metal theme.")

(modus-themes-theme
 'black-metal-bathory
 'black-metal-themes
 "Black Metal (Bathory) variant generated with modus-themes-tool."
 'dark
 'black-metal-bathory-palette
 nil
 nil)

(provide-theme 'black-metal-bathory)
