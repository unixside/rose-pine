;; black-metal-dark-funeral-theme.el --- -*- lexical-binding: t -*-
(require 'modus-themes)

(defvar black-metal-dark-funeral-palette
  (modus-themes-generate-palette
   '(
     ...
     (green-cooler     "#c0cfde")
     (green-faint      "#c0cfde")
     (green-intense    "#e0effe")

     (yellow           "#5f81a5")
     (yellow-warmer    "#6f91b5")
     (yellow-cooler    "#4f7195")
     (yellow-faint     "#4f7195")
     (yellow-intense   "#6f91b5")
     ...
     (bg-green-subtle    "#141617")
     (bg-green-faint      "#0d0e0e")
     (bg-green-nuanced    "#0d0e0e")
     (bg-green-intense    "#25282a")

     (bg-yellow-subtle   "#10151b")
     (bg-yellow-faint     "#0a0d11")
     (bg-yellow-nuanced   "#0a0d11")
     (bg-yellow-intense   "#1d2732")
     ...
     (modeline-err     "#5f8787")
     (modeline-warning "#5f81a5")
     (modeline-info    "#d0dfee")
     ...
     ;; Diffs
     (bg-added           "#101213")
     (bg-added-faint     "#0a0b0b")
     (bg-added-refine    "#161819")
     (bg-added-fringe    "#232628")
     (fg-added           "#d0dfee")
     (fg-added-intense   "#e0effe")

     (bg-changed         "#0d1116")
     (bg-changed-faint   "#080a0d")
     (bg-changed-refine  "#11171e")
     (bg-changed-fringe  "#1b2530")
     (fg-changed         "#5f81a5")
     (fg-changed-intense "#6f91b5")
  ...
  "Color palette of the dark funeral variant of the Black Metal theme.")

(modus-themes-theme
 'black-metal-dark-funeral
 'black-metal-themes
 "Black Metal (Dark Funeral) variant generated with modus-themes-tool."
 'dark
 'black-metal-dark-funeral-palette
 nil
 nil)

(provide-theme 'black-metal-dark-funeral)
